# Salary Estimation Using Regression Models
...
3. **Evaluation:**
   * Evaluating models using **Root Mean Squared Error (RMSE)** and the **Coefficient of Determination ($R^2$ Score)**.
   * Visualizing True vs. Predicted salary values using interactive Plotly charts.
